...
<div class="pattern-header bg-primary col-3"> Extension </div>
::: {.pattern-body .col-9}
[DerivingAnyClass][DeriveAnyClass]
:::
...
>
> __GHC user guide__, `StandaloneDeriving``
...
| Any typeclass implemented by the wrapped type of the newtypes | newtype  | `GeneralizedNewtypeDeriving`, `GeneralisedNewtypeDeriving` |
