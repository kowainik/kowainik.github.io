...
`cabal-example.cabal` describes the structure of your package. Put your source
code under the `src/` folder. Don’t worry about the `Setup.hs` file as it is not
needed most of the time. You can ignore it or even delete it.
